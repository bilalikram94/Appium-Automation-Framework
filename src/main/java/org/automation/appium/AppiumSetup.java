...
public final class AppiumSetup {
    Logger logger = LoggerFactory.getLogger(AppiumSetup.class);
...
//            builder.withEnvironment(env);
    ...
    public static void createCapabilityFile() throws IOException, JadbException {
        ...
        for (JadbDevice device : devices) {
            ...
            String platFormName = PropertyUtils.get(ConfigMap.PLATFORMNAME);
            String automationName = PropertyUtils.get(ConfigMap.AUTOMATIONNAME);
            ...
            content = content.replace("\"platformName\": \"\"", "\"platformName\": \"" + platFormName + "\"");
            content = content.replace("\"automationName\": \"\"", "\"automationName\": \"" + automationName + "\"");
    ...
    public static Object getCapability(String key, String udid) {
        ...
        try {
            JSONArray jsonArray = (JSONArray) jsonParser.parse(new FileReader(GlobalVars.getResPath1() + "capabilities/" + udid + ".json"));
